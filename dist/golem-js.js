...
function createDefaultStorageProvider(yagnaApi, logger) {
    if (golemNetwork.isNode) {
        return new golemNetwork.GftpStorageProvider(logger === null || logger === void 0 ? void 0 : logger.child("storage"));
    }
    if (golemNetwork.isBrowser) {
        return new golemNetwork.WebSocketBrowserStorageProvider(yagnaApi, {
...
exports.WebSocketBrowserStorageProvider = golemNetwork.WebSocketBrowserStorageProvider;
