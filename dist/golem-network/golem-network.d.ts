...
export declare class GolemNetwork {
     ...
     */
    oneOf({ order, setup, teardown, signalOrTimeout }: OneOfOptions): Promise<ResourceRental>;
    /**
     ...
     * @param options.teardown - an optional function that is called before the exe unit is destroyed
     */
    manyOf({ poolSize, order, setup, teardown }: ManyOfOptions): Promise<ResourceRentalPool>;
    isConnected(): boolean;
    /**
