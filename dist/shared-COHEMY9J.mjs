...
class WebSocketBrowserStorageProvider {
    constructor(yagnaApi, options) {
        ...
        this.ready = false;
        this.logger = (_a = options.logger) !== null && _a !== void 0 ? _a : nullLogger();
    }
    close() {
        this.ready = false;
    ...
    async publishData(data) {
        ...
        ws.addEventListener("message", (event) => {
            ...
            if (req.component === "GetMetadata") {
                ...
                this.logger.error(`[WebSocketBrowserStorageProvider] Unsupported message in publishData(): ${req.component}`);
            }
        });
        return fileInfo.url;
    }
    ...
    async receiveData(callback) {
        ...
        ws.addEventListener("message", (event) => {
            ...
            if (req.component === "UploadChunk") {
                ...
                this.logger.error(`[WebSocketBrowserStorageProvider] Unsupported message in receiveData(): ${req.component}`);
            }
        });
        return fileInfo.url;
    }
    ...
    async release(urls) {
        urls.forEach((url) => {
            ...
            if (serviceId) {
                this.deleteService(serviceId).catch((error) => this.logger.warn(`[WebSocketBrowserStorageProvider] Failed to delete service`, { serviceId, error }));
            }
...
class ExeUnit {
    ...
    async deployActivity() {
        var _a, _b;
        try {
            const executionMetadata = await this.executor.execute(new Script([new Deploy((_b = (_a = this.networkNode) === null || _a === void 0 ? void 0 : _a.getNetworkConfig) === null || _b === void 0 ? void 0 : _b.call(_a)), new Start()]).getExeScriptRequest());
            const result$ = this.executor.getResultsObservable(executionMetadata);
...
class GolemNetwork {
    constructor(options = {}) {
        ...
        try {
            ...
            this.services = {
                ...
                fileServer: ((_k = this.options.override) === null || _k === void 0 ? void 0 : _k.fileServer) || new GftpServerAdapter(this.storageProvider),
            };
     ...
     */
    async oneOf({ order, setup, teardown, signalOrTimeout }) {
     ...
     * @param options.teardown - an optional function that is called before the exe unit is destroyed
     */
    async manyOf({ poolSize, order, setup, teardown }) {
        var _a, _b;
...
export { GolemTimeoutError as $, Agreement as A, BasicDemandDirector as B, ActivityStateEnum as C, Demand as D, Result as E, ExecutionConfig as F, GolemInternalError as G, ActivityModuleImpl as H, Invoice as I, ExeUnit as J, Batch as K, RemoteProcess as L, MarketErrorCode as M, NullStorageProvider as N, OfferProposal as O, PaymentDemandDirector as P, GolemWorkError as Q, ResourceRental as R, ScanDirector as S, WorkErrorCode as T, TcpProxy as U, GolemError as V, WebSocketBrowserStorageProvider as W, GolemUserError as X, GolemAbortError as Y, GolemConfigError as Z, GolemPlatformError as _, GftpStorageProvider as a, GolemModuleError as a0, sleep as a1, nullLogger as a2, defaultLogger as a3, env as a4, YagnaApi as a5, isWebWorker as a6, checkAndThrowUnsupportedInBrowserError as a7, createAbortSignalFromTimeout as a8, anyAbortSignal as a9, runOnNextEventLoopIteration as aa, mergeUntilFirstComplete as ab, waitFor as ac, waitAndCall as ad, PaymentApiAdapter as ae, MarketApiAdapter as af, InvoiceRepository as ag, DebitNoteRepository as ah, MIN_SUPPORTED_YAGNA as ai, EventReader as aj, getPaymentNetwork as ak, isBrowser as b, GolemNetwork as c, ResourceRentalPool as d, RentalModuleImpl as e, DemandSpecification as f, GolemMarketError as g, WorkloadDemandDirector as h, isNode as i, DraftOfferProposalPool as j, MarketModuleImpl as k, ScannedOffer as l, DebitNote as m, Allocation as n, RejectionReason as o, GolemPaymentError as p, PaymentErrorCode as q, InvoiceProcessor as r, PaymentModuleImpl as s, NetworkState as t, Network as u, NetworkNode as v, NetworkModuleImpl as w, NetworkErrorCode as x, GolemNetworkError as y, Activity as z };
//# sourceMappingURL=shared-COHEMY9J.mjs.map
